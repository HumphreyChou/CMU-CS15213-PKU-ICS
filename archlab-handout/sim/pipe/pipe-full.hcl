...
####################################################################
# 					iaddq V, rB
# Modification 1: instr_valid includes IIADDQ
# Modification 2: need_regids includes IIADDQ
# Modification 3: need_valC includes IIADDQ
# Modification 4: d_srcB, D_icode includes IIADDQ to assign D_rB to d_srcB
# Modification 5: d_dstE, D_icode includes IIADDQ to assign D_rB to d_dstE
# Modification 6: aluA, E_icode includes IIADDQ to assign E_valC to aluA
# Modification 7: aluB, E_icode includes IIADDQ to assign E_valB to aluB
# Modification 8: set_cc, E_icode includes IIADDQ
####################################################################
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IIADDQ }; ## Chou
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ }; ## Chou

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IIADDQ }; ## Chou
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IIADDQ  } : D_rB; ## Chou
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IIADDQ} : D_rB; ## Chou
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IIADDQ } : E_valC; ## Chou
...
word aluB = [
	E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, 
		     IPUSHQ, IRET, IPOPQ, IIADDQ } : E_valB; ## Chou
...
bool set_cc = E_icode in {IOPQ, IIADDQ} && 
	...
	!m_stat in { SADR, SINS, SHLT } && !W_stat in { SADR, SINS, SHLT }; ## Chou
